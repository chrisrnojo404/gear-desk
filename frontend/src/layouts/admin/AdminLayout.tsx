...
const navigationItems = [
  { to: '/dashboard/admin', label: 'Admin dashboard', end: true },
  { to: '/dashboard/admin/users', label: 'Gebruikersbeheer' },
  { to: '/dashboard/admin/equipment', label: 'Apparatuurbeheer' },
  { to: '/dashboard/admin/categories', label: 'Categoriebeheer' },
  { to: '/dashboard/admin/reports', label: 'Rapporten' },
  { to: '/dashboard/admin/logs', label: 'Logs' },
]
      ...
      <div className="mx-auto grid min-h-[calc(100vh-2rem)] max-w-7xl gap-4 lg:grid-cols-[300px_minmax(0,1fr)]">
        ...
        <main className="panel-glow rounded-[2rem] border border-white/10 bg-panel-900/85 p-5 backdrop-blur-xl sm:p-6 lg:p-8">
          <div className="mb-6 flex flex-col gap-3 rounded-[1.75rem] border border-white/10 bg-white/5 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-xs tracking-[0.18em] text-slate-400 uppercase">Level 3 omgeving</p>
              <p className="mt-1 text-sm text-slate-300">
                Beheer gebruikers, assets, categorieen en operationele inzichten.
              </p>
            </div>
